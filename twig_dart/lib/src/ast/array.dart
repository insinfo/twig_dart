...
class Array extends Expression {
  ...
  @override
  FileSpan get span {
    return items.fold<FileSpan>(lBracket.span, (out, i) => out.expand(i.span)).expand(rBracket.span);
  }
}
...
class IndexerExpression extends Expression {
  ...
  @override
  FileSpan get span {
    return target.span.expand(lBracket.span).expand(indexer.span).expand(rBracket.span);
  }
